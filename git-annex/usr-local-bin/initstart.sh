...
/usr/bin/git annex initremote Fudge type=tahoe embedcreds=yes

# Full path to initremote.sh executable
# Location of local repo
# Nickname of your PC in Tahoe grid
# Web UI port for Tahoe on your PC - NOT same as Tahoe grid
# Needed - must match Tahoe grid
# Happy - must match Tahoe grid
# Total - must match Tahoe grid
/usr/local/bin/initremote.sh /opt/git/Fudge_repo ctidev5 4615 3 4 5
